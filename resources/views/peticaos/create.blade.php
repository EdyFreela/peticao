          ...
          <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade" id="alemao">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 idioma-ativo">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            -->
                            {{ Form::hidden('ativo_de', 'Y', array('class'=>'ativo_de', 'id'=>'ativo_de')) }}
                        <!--
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Conteúdo:</strong>
                        {!! Form::textarea('conteudo_de', null, array('placeholder' => 'Conteúdo','class' => 'form-control')) !!}
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Petição:</strong>
                        {!! Form::textarea('peticao_de', null, array('placeholder' => 'Conteúdo','class' => 'form-control')) !!}
                    </div>
                </div>                               
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
