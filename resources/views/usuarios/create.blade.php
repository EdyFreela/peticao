...
<div class="container">
        ...
        <div class="col-md-12">
            <div>
                <ul class="breadcrumb">
                    ...
                    <li class="active"><a href="{{ route('usuarios.index') }}">Administrador</a></li>
            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-left">
                        <h2><i class="fa fa-lock" aria-hidden="true"></i> Novo Administrador</h2>
                    </div>
                </div>
            </div>          
        </div>
    ...
    @endif
    {!! Form::open(array('route' => 'usuarios.store','method'=>'POST', 'files' => true)) !!}
    <div class="row">        
