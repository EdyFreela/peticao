        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-left">
                        <h2><i class="fa fa-users" aria-hidden="true"></i> Gestão de Newsletter</h2>
                    </div>
                </div>
            </div>
                        ...
                        @foreach($items as $key => $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    {!! Form::open(['id' => 'item-delete-'.$item->id, 'method' => 'DELETE','route' => ['newsletters.destroy', $item->id],'style'=>'display:inline']) !!}
